...
public class Order05 extends ActionBarActivity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_order05);
	...
	private void showItems() {
		...
		if (extras == null) {
			...
			itemListView.append("\n");
			itemListView.append("Table 5 has not ordered yet" + "\n");
			itemListView.append("\n");
		}
		if (extras != null) {
			...
			itemListView.setTextSize(15);
			itemListView.append("\n");
			itemListView.append("Table 5 has ordered the following items"
					+ "\n");
			itemListView.append("\n");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.order05, menu);
		return true;
	}
	...
	private void showBill() {
		...
		calculateBill.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				priceListView.append("Table 5 cost for the meal is ");
				priceListView.append("\n");
				priceListView.append("\n");
